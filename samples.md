...
```java
Observation bestObs = new Experiment("432").bestObservation().call();
```

## Authentication

Authentication is done by setting your user_token and client_token.
...
*NOTE* - Ideally this wouldn't require the clientId.
